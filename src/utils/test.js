...
// })()
// const formula="Income.total - Expense.total * Income.total / Income.total + Income.total"
// const expressionPattern=/\s[-+*/]\s/ig
// const search=formula.match(expressionPattern);
